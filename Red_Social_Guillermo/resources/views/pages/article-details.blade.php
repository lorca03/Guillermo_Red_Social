            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.blade.php">Home</a><i class="fa fa-angle-double-right"></i><span>Longer Project Title Should Go Here</span>
                ...
                <div class="col-md-4">
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Read our <a class="white" href="terms-conditions.blade.php">Terms & Conditions</a>, <a class="white" href="privacy-policy.blade.php">Privacy Policy</a></div>
                            </li>
                        </ul>
                    </div>
                </div> <!-- end of col -->
