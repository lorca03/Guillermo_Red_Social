<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-4 flex items-center justify-center flex-col">
            <div class="bg-white overflow-hidden w-1/2 shadow-xl shadow-indigo-500/40 sm:rounded-lg p-5 mb-5">
            ...
            <div class="bg-white overflow-hidden w-1/2 shadow-xl shadow-indigo-500/40 sm:rounded-lg p-5 ">
                @foreach($users as $user)
                    ...
                    <h1>{{$user->name}} {{$user->surname}}  <a class="text-indigo-500" href="usuarios/{{$user->name}}"><span>@</span>{{$user->user_name}}</a></h1>
                @endforeach
